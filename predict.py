...
if form.getvalue('q9'):
    q9_value = form.getvalue('1' or '2') 
    result =  'أنت مُعَرّض للإصابة بمرض كوفيد-19 \n وسبب ذلك أن مناعتك ضعيفة بعض الشيء، لذلك عليك عزيزي الالتزام بأخذ فيتامينات ومقويات مناعة تحت إشراف طبيب مختص، بالإضافة إلى الحرص على تناول الخضراوات والفواكه التي تساعد على تعزيز المناعة (مثل الفلفل الحلو، والحمضيات) '
elif form.getvalue('q10'):
    q10_value = form.getvalue('1' or '2' or '3' or '4' or '5')
    result =  'أنت مُعَرّض للإصابة بمرض كوفيد-19 \n وسبب ذلك أن صحتك ليست جيدة جداً، لذلك عليك عزيزي الحفاظ على صحتك وعد الانقطاع عن مراجعة طبيبك الخاص، بالإضافة إلى الحرض على تناول الفيتامينات والأغذية الغنية بها كي تحافظ على مناعة أعلى وصحة أفضل'
elif form.getvalue('q16'):
    q16_value = form.getvalue('1')
    result =  'أنت مُعَرّض للإصابة بمرض كوفيد-19 \n وسبب ذلك عدم التزامك بارتداء الكمامة عند الخروج من المنزل ومقابلة الآخرين، وذلك يجعلك عُرضةً للعدوى، رجاءً التزم بإجراءات الوقاية '
elif form.getvalue('q27'):
    q27_value = form.getvalue('1') 
    result =  'أنت مُعَرّض للإصابة بمرض كوفيد-19 \n وسبب ذلك طبيعة عملك، فمجالات العمل المذكورة في الفحص هي أكثر المجالات التي يجتمع فيها عدد كبير من الأشخاص، لذا عليك عزيزي الالتزام بالتعقيم وارتداء الكمامة، وكذلك الحفاظ على مسافة أمان بينك وبين الآخرين '
elif form.getvalue('q28'):
    q28_value = form.getvalue('1')
    result =  'أنت مُعَرّض للإصابة بمرض كوفيد-19 \n وسبب ذلك مخالطتك لعدد يفوق الخمسة أشخاص من غير عائلتك، إن كنت تستطيع عدم الاختلاط بهذا الشكل فافعل، وإن كانت طبيعة عملك تُحتّمُ عليك ذلك، يجب عليك الحفاظ على إجراءات الوقاية من ارتداءٍ للكمامة، والتعقيم والحفاظ على مسافة أمانٍ بينك وبين الآخرين'
elif form.getvalue('q30'):
    q30_value = form.getvalue('2')
    result =  'أنت مُعَرّض للإصابة بمرض كوفيد-19 \n وسبب ذلك عدم التزامك بالحجر الصحي بعد عودتك من السفر، تدارك الأمر وقم بحجر نفسك مدة أربعة عشرة يوماً للتأكد من عدم إصابتك'
elif form.getvalue('q31'):
    q31_value = form.getvalue('1')
    result =  'أنت مُعَرّض للإصابة بمرض كوفيد-19 \n وسبب ذلك مخالطتك لمصاب، احتمالية إصابتك في هذه الحالة عالية جداً، عليك الالتزام بالحجر المنزلي مدة لا تقل عن أربعة عشرة يوماً، واحرص على تناول المكملات الغذائية والفيتامينات، أو خذ حاجتك منها عن طريقة الغذاء الصحي كالفواكه الحمضية والفلفل الحلو '
elif form.getvalue('q33'):
    q33_value = form.getvalue('1')
    result =  'أنت مُعَرّض للإصابة بمرض كوفيد-19 \n وسبب ذلك مخالطتك لمصاب، احتمالية إصابتك في هذه الحالة عالية جداً، عليك الالتزام بالحجر المنزلي مدة لا تقل عن أربعة عشرة يوماً، واحرص على تناول المكملات الغذائية والفيتامينات، أو خذ حاجتك منها عن طريقة الغذاء الصحي كالفواكه الحمضية والفلفل الحلو '
elif form.getvalue('q34'):
    q34_value = form.getvalue('1')
    result =  'أنت مُعَرّض للإصابة بمرض كوفيد-19 \n وسبب ذلك كثرة عدد الإصابات في منطقتك، عليك الحرص والالتزام بتدابير الوقاية الصحية، من ارتداء الكمامة،والتعقيم، والمحافظة على مسافة أمان بينك وبين الآخرين '
